...
Skybox::Skybox(const ComPtr<ID3D12Device>& device, const ComPtr<ID3D12GraphicsCommandList>& commandList, const ComPtr<ID3D12RootSignature>& rootSignature) : m_faces{ new GameObject[6] }
{
	...
	frontTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxFront.dds"));
	...
	leftTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxLeft.dds"));
	...
	rightTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxRight.dds"));
	...
	backTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxBack.dds"));
	...
	topTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxTop.dds"));
	...
	botTexture->LoadTextureFile(device, commandList, 2, TEXT("resource/SkyboxBot.dds"));
