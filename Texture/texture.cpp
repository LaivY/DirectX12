...
void Texture::UpdateShaderVariable(const ComPtr<ID3D12GraphicsCommandList>& commandList, D3D12_GPU_DESCRIPTOR_HANDLE srvGpuDescriptorHandle)
{
	commandList->SetGraphicsRootDescriptorTable(0, srvGpuDescriptorHandle);
}
