    ...
    _In_       int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TESSELLATION, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TESSELLATION));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_TESSELLATION));
