...
class WireTerrainShader : public Shader
{
public:
	WireTerrainShader(const ComPtr<ID3D12Device>& device, const ComPtr<ID3D12RootSignature>& rootSignature);
	~WireTerrainShader() = default;
